...
import type { CategorieSignalement, SessionStep, RemoteMessage, TandemStatus, UnblockAffordance, PartageDuJournal, EtatDeSemaine, InvitationDouce } from '@agapeplay/domain'
