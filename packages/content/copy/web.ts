...
export const copy = {
  fr: {
    ...
    deleteConfirmKeeps: 'Ce qui reste : les messages que tu as envoyés restent dans la conversation de ton binôme, sans ton nom au-dessus. Un signalement déjà déposé reste aussi, parce qu’il protège quelqu’un.',
  ...
  en: {
    ...
    deleteConfirmKeeps: 'What stays: the messages you sent stay in your partner’s conversation, with no name above them. A report already filed stays too, because it protects someone.',
